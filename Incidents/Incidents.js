...
import {
  ...
  onShareIncidentSubscription as onShareIncidentSubscriptionQuery,
} from '../../appsync-service/graphql/subscriptions'
import {
  addNewIncidentMessage,
  getLoading as isIncidentMessageloading,
...
class Incidents extends React.Component {
  static propTypes = {
    ...
    incidentMessageloading: PropTypes.bool,
  }
  ...
  constructor() {
    ...
    this.shareIncidentSubscription = null
  ...
  loadSubscriptions = () => {
    ...
    this.onShareIncidentSubscription()
  ...
  async onShareIncidentSubscription() {
    this.shareIncidentSubscription = client
      .subscribe({
        query: onShareIncidentSubscriptionQuery,
      })
      .subscribe({
        next: async ({ data }) => {
          let incident = data.onShareIncident?.item
          if (!incident) return
        ...
        error: error =>
          console.log('error onShareIncidentSubscription::', error),
      })
  }
  ...
  render() {
    ...
    return (
      <section className="incidents">
        <span className="incidents__span">
          {incidentsShowMode === 'normal' ? 'Incidents' : 'Closed Incidents'}
        </span>
        <div className="incidents__header">
          <div className="incidents__CardNumber">
            <NumberCard
          ...
          {!event ? (
            ...
            <div className="incidents__BtnGrop">
              <div>
                <DashboardSelect
                  options={[
                    { value: '', label: 'All' },
...
export default compose(
  ...
  connect(state => {
    ...
    return {
      ...
      incidentMessageloading: isIncidentMessageloading(state),
      groupIconSrc:
