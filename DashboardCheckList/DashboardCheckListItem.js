...
import iconUser from '../../images/icons/icon-user-circle.svg'
import iconMarker from '../../images/icons/icon-map-pin.svg'
            ...
            <div className="check-list__item__details">
              ...
              <div className="check-list__item__excerpts">
                <div className="check-list__item__excerpt">
                  <Icon src={iconUser} size={10} />
                  {assigneesText}
                </div>
                <div className="check-list__item__excerpt">
                  <Icon src={iconMarker} size={10} />
                  {adminCheck.zones.join(', ') || 'No zone'}
                </div>
                <div className="check-list__item__time">
                  <Icon src={iconClock} size={10} />
