  ...
  (
    ...
    return (
      <div
        ...
        className={
          incidentTable
            ? `incident-detail-table__body incident-detail-table--scrollable`
            : `admin-table__body admin-table__body--scrollable`
        }
        // style={{ height: rowPerPage > 0 ? rowPerPage + 1 : null }}
      >
        <DragDropContext
            ...
            <Droppable droppableId="droppable" isDropDisabled={!onOrderChange}>
              {provided => (
                <tbody ref={provided.innerRef} {...provided.droppableProps}>
                  {loading && !data.length ? <Loading centered /> : null}
                  {!loading && data.length
                    ? data.map((row, i) => {
                        return (
                          <Draggable
                              ...
                              >
                                ...
                                {!!onOrderChange && (
                                  <td
                                    className={
                                      incidentTable
                                        ? 'incident-detail-table-order-cell'
                                ...
                                {rowActions.length > 0 && (
                                  <td
                                    ...
                                    style={{
                                      width: getWidth(columns.length + 3),
                                    }}
                                  >
