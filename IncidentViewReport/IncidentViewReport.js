...
import IVSPlayerView from '../common/IVSPlayerView'
...
const IncidentViewReport = ({
  ...
  let { capture_data, location } = incident

  if(typeof incident.stored_videos === 'string'){
    incident.stored_videos = JSON.parse(incident.stored_videos)
  }
    ...
    <div className="incident-view-reports">
      <table>
        <tbody>
          ...
          {incident.stored_videos && (
                <tr>
                  <th>Incident Videos</th>
                  <td>
                    <p>Name: {incident.stored_videos.name}</p>
                    <p>Description: {incident.stored_videos.description}</p>
                    <IVSPlayerView videoSrc={incident.stored_videos.link} 
                      autoPlay={false}
                      controls
                    />
                  </td>
