      ...
      >
        <defs>
          <linearGradient id="colorUv" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor="#1D80BE94" stopOpacity={0.8} />
            <stop offset="95%" stopColor="#1D80BE94" stopOpacity={0} />
          </linearGradient>
        ...
        <Tooltip />
        <Area type="monotone" dataKey="uv" stroke="black" fill="url(#colorUv)" />
        <Area type="monotone" dataKey="pv" stroke="black" fill="url(#colorUv)" />
