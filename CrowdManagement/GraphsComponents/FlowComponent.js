  ...
  return (
    <div>
      ...
      >
        ...
        <Tooltip />
        <Area type="monotone" dataKey="dynamicSentimentOfCrowd.dominantEmotion" stroke="black" fill="url(#colorUv)" />
        <Area type="monotone" dataKey="dynamicSentimentOfCrowd.dominantEmotionValue" stroke="black" fill="url(#colorUv)" />
